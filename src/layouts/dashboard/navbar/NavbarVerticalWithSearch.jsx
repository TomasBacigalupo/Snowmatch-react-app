...
const NavbarStyle = styled(Box)(({ theme, isoffset }) => ({
  transition: theme.transitions.create(['padding-top'], {
    duration: theme.transitions.duration.shorter,
  }),
  paddingTop: isoffset === 'true' ? 'env(safe-area-inset-top)' : 'calc(env(safe-area-inset-top) + 48px)',
}));
...
NavbarVerticalWithSearch.propTypes = {
  isOpenSidebar: PropTypes.bool,
  onCloseSidebar: PropTypes.func,
  isGuest: PropTypes.bool,
};

export default function NavbarVerticalWithSearch({ isOpenSidebar, onCloseSidebar, isGuest, isAdmin }) {
  ...
  const renderContent = (
    ...
    >
      <NavbarStyle isoffset={isOffset.toString()}>
        <Stack
          spacing={3}
          sx={{
            pb: 2,
