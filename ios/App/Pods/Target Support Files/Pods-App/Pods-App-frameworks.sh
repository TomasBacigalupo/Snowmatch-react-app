...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorInappbrowser/CapacitorInappbrowser.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapgoCapacitorSocialLogin/CapgoCapacitorSocialLogin.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CoderpradpCapacitorPluginVideoPicker/CoderpradpCapacitorPluginVideoPicker.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/OSInAppBrowserLib/OSInAppBrowserLib.framework"
fi
