          ...
          children: [
            ...
            { path: 'kanban', element: <Kanban /> },
            {
              ...
              children: [
                ...
                { path: 'financial/:category', element: <AdminFinancialBookingsDetail /> },
...
const AdminFinancialBookingsDetail = Loadable(lazy(() => import('../pages/dashboard/AdminFinancialBookingsDetail')));
