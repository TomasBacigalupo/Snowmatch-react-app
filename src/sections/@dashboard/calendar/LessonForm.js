    ...
    return (
        <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
            <Stack spacing={3} sx={{ p: 3 }}>
                ...
                <RHFTextField disabled name="title" label={translate('calendar.form.title')} />
                ...
                {values?.type && !['Break', 'Training', 'Illness'].find(p => p === values.type) && (
                    <RHFTextField name="price" disabled label={translate('calendar.form.price')} />
                )}
            ...
            <DialogActions>
                {!isCreating && (
                    <Tooltip title="Delete Event" disabled>
