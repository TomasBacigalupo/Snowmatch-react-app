...
export const PATH_AUTH = {
  ...
  guestDetails: path(ROOTS_AUTH, '/guest-details'),
...
export const PATH_DASHBOARD = {
  ...
  admin: {
    ...
    clinics: path(ROOTS_DASHBOARD, '/admin/clinics'),
    clinicDetail: (id) => path(ROOTS_DASHBOARD, `/admin/clinics/${id}`),
    clinicInterests: path(ROOTS_DASHBOARD, '/admin/clinic-interests'),
