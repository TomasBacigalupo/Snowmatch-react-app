                ...
                <Grid container p={2} spacing={3} alignItems='center'>
                    <Grid item xs={12}>
                        <Typography variant="body2">
                            {translate('checkout.guests_description')}
                        </Typography>
                    </Grid>
                    <Grid item xs={6}>
                        <Typography variant="body" sx={{ mb: 3 }}>
                            {translate('checkout.guests_adulsts')}
                            
                        </Typography>
                        <Typography variant="body2" sx={{ mb: 3 }}>
                            {translate('checkout.guests_adulsts_description')}
                    ...
                    <Grid item xs={6}>
                        <Typography variant="body" sx={{ mb: 3 }}>
                            {translate('checkout.guests_children')}
                            
                        </Typography>
                        <Typography variant="body2" sx={{ mb: 3 }}>
                            {translate('checkout.guests_children_description')}
