...
export default function AdminFinancialDashboard() {
  ...
  const kpis = {
    ...
    paidBookingsTotalUsd: summary.paidBookingsTotalUsd || 0,
    paidBookingsCountUsd: summary.paidBookingsCountUsd || 0,
    unpaidBookingsTotal: summary.unpaidBookingsTotal || 0,
    unpaidBookingsCount: summary.unpaidBookingsCount || 0,
    unpaidBookingsTotalUsd: summary.unpaidBookingsTotalUsd || 0,
    unpaidBookingsCountUsd: summary.unpaidBookingsCountUsd || 0,
