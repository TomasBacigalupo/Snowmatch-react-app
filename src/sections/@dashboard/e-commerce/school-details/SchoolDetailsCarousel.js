...
SchoolDetailsCarousel.propTypes = {
    business: PropTypes.shape({
    images: PropTypes.arrayOf(PropTypes.string),
  }),
};

export default function SchoolDetailsCarousel({ business }) {
  ...
  const [source, setSource] = useState(business.images[0])
  ...
  const imagesLightbox = business.images.map((_image) => _image);
  ...
  const settings2 = {
    ...
    variableWidth: true,
    centerPadding: '0px',
    slidesToShow: business.images.length > 3 ? 3 : business.images.length,
  };
