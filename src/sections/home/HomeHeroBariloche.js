...
export default function HomeHeroBariloche() {
      ...
      <Container sx={{
        ...
        <ContentStyle>
          <Grid container spacing={2} justifyContent='center' alignItems='space-between' sx={{
            ...
            <Grid item xs={12} container spacing={6}>
              <Grid item xs={12}>
                <Typography variant="h1" sx={{ color: 'white' }}>
                  Clases de ski en Bariloche
                </Typography>
              </Grid>
              <Grid item xs={12}>
                <Typography variant="subtitle1" sx={{ color: 'white' }}>
                  Reservá tu clase de ski en el cerro Catedral en menos de un minuto con SnowMatch.
                </Typography>
              </Grid>
            </Grid>
            ...
            <Grid item xs={12}>
            <br /><br />
              <HomeFilterTeachersBariloche />
            </Grid>
            <br /><br /><br /><br /><br /><br />
            <Grid item xs={6}>
              <a href="https://snowmatch.pro/match/product/145" style={{
                color: 'white',
                '&:hover': {
            ...
            <Grid item xs={6}>
              <a href="https://snowmatch.pro/match/product/144" style={{
                color: 'white',
                '&:hover': {
                  textDecoration: 'underline'
                }
