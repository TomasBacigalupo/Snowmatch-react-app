...
import HomeHeroLagoHermoso from 'src/sections/home/HomeHeroLagoHermoso';
...
export default function HomePage() {
  ...
  return (
    <Page title="Match a PRO">
      <Helmet>
        <title>Clases de ski en Lago Hermoso | SnowMatch</title>
        <meta name="description" content="Clases de ski en Lago Hermoso" />
        <meta property="og:title" content="Clases de ski en Lago Hermoso para todos los niveles" />
        <meta property="og:description" content="Reservá tu clase en Lago Hermoso en menos de un minuto con SnowMatch. Más de 100 instructores habilitados. Clases de ski y snowboard evitando colas y demoras. ¡Cupos limitados!" />
              ...
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
                  "url": "https://snowmatch.pro/match/school?resort=Lago%20Hermoso"
                },
                {
                  "@type": "ListItem",
                  "position": 2,
                  "url": "https://snowmatch.pro/match/teacher/167"
                },
                {
                  "@type": "ListItem",
                  "position": 3,
                  "url": "https://snowmatch.pro/match/teacher/682"
                },
                {
                  "@type": "ListItem",
                  "position": 4,
