...
import RegisterStepperForm from 'src/sections/auth/register/RegisterStepperForm';
            ...
            <MobileStickyFooterStyle>
              ...
              <Box sx={{ display: 'flex', gap: 2 }}>
                ...
                <LoadingButton
                  ...
                  sx={{ 
                    py: 1.5,
                    bgcolor: currentStep === 9 ? 'primary.main' : 'black',
                    color: 'white',
                    borderRadius: 2,
                    '&:hover': { 
                      bgcolor: currentStep === 9 ? 'primary.dark' : 'grey.800',
                      color: 'white'
                    },
                    '&:disabled': {
                      bgcolor: 'grey.400',
